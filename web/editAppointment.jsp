<%-- 
    ...
    Created on : Jan 25, 2022, 12:46:10 PM
    Author     : Fatin Amalin
--%>
        ...
        <div class="main-container">
            <div class="card-box mb-30">
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <form method="post" action="AppEditController">
                        ...
                        <div class="form-group">
                            ...
                            <tr><td><input  type="datetime-local" name="AppointmentDateTime" value="${dateTime_query4}" required></td></tr>
                            </table>
                        </div>
                        <div class="form-group">
