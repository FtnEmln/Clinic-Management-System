<%-- 
    Document   : login_emp
    Created on : Feb 3, 2022, 12:42:10 AM
    Author     : Farah
--%>
				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-primary">Login To WeCare Clinic</h2>
						</div>
						<form action="login_empServlet2" method="post">
							...
							<div class="input-group custom">
								<input type="text" name="n" class="form-control form-control-lg" placeholder="Username">
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group mb-0">
										...
										-->
										<a class="btn btn-primary btn-lg btn-block" href="addDoctor.jsp">Sign In</a>
									</div>
