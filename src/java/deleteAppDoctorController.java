 ...
 * @author Fatin Amalin
 */
public class deleteAppDoctorController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		{   ex.printStackTrace();
                    ...
                    request.setAttribute("errorMsgs", errorMsgs);
                    RequestDispatcher view = request.getRequestDispatcher("/prescriptionList.jsp");
                    view.forward(request, response); 
                }
            }
            else
...
//                view.forward(request, response); 
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(deleteAppDoctorController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
