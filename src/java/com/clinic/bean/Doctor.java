...
public class Doctor {
    ...
    public Doctor(String EmpICNo, String EmpFName, String EmpLName, String EmpAddress, String StartDate, String EmpPhone, int EmpTypeID, String Username, String Password)
    {
